...
export default function Employees() {
  ...
  const BULK_UPDATABLE_FIELDS: Record<string, string> = {
    ...
    remoteLoginAuthorized: "Remote Login Authorized",
    biometricDeviceId: "Biometric Device ID",
    attendanceExempt: "Attendance Exempt",
    compOffEligible: "Comp-Off Eligible",
  ...
  const CSV_HEADER_ALIASES: Record<string, string> = {
    ...
    "remote login authorized": "remoteLoginAuthorized", "remote login": "remoteLoginAuthorized", "remote authorized": "remoteLoginAuthorized",
    "attendance exempt": "attendanceExempt",
    "comp off eligible": "compOffEligible", "compoff eligible": "compOffEligible", "comp-off eligible": "compOffEligible",
